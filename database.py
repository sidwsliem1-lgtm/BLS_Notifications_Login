"""
SQLite database operations for storing device sessions.
...
class Database:
    ...
    async def get_latest_session_by_telegram(self, telegram_id: int, exclude_id: Optional[int] = None) -> Optional[Dict[str, Any]]:
        """
        Get the most recent session for a given Telegram ID.
        Optionally exclude a specific session ID.
        """
        query = """
    ...
    async def get_latest_session_by_phone(self, phone: str, exclude_id: Optional[int] = None) -> Optional[Dict[str, Any]]:
        """
        Get the most recent session for a given phone number.
        Optionally exclude a specific session ID.
        """
        query = """
            SELECT * FROM sessions 
